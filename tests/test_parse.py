    ...
    def test_aggregate(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                'path("a",0,"a").',
                'aggregate("product","sum(b)","sum").',
                'aggregate_set("product","sum(b)","b").',
                'path("b",0,"b").',
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                'path("a",0,"a").',
                'aggregate("product","sum(b,c)","sum").',
                'aggregate_set("product","sum(b,c)","b").',
                'aggregate_set("product","sum(b,c)","c").',
                'path("b",0,"b").',
                'path("c",0,"c").',
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                'path("a",0,"a").',
                'aggregate("product","count(b)","count").',
                'aggregate_set("product","count(b)","b").',
                'path("b",0,"b").',
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                'path("a",0,"a").',
                'aggregate("product","count(b,c)","count").',
                'aggregate_set("product","count(b,c)","b").',
                'aggregate_set("product","count(b,c)","c").',
                'path("b",0,"b").',
                'path("c",0,"c").',
            ],
        )
        self.assertEqual(
            ...
            [
                ...
                'path("a",0,"a").',
                'aggregate("product","min(b)","min").',
                'aggregate_set("product","min(b)","b").',
                'path("b",0,"b").',
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                'path("a",0,"a").',
                'aggregate("product","min(b,c)","min").',
                'aggregate_set("product","min(b,c)","b").',
                'aggregate_set("product","min(b,c)","c").',
                'path("b",0,"b").',
                'path("c",0,"c").',
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                'path("a",0,"a").',
                'aggregate("product","max(b)","max").',
                'aggregate_set("product","max(b)","b").',
                'path("b",0,"b").',
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                'path("a",0,"a").',
                'aggregate("product","max(b,c)","max").',
                'aggregate_set("product","max(b,c)","b").',
                'aggregate_set("product","max(b,c)","c").',
                'path("b",0,"b").',
                'path("c",0,"c").',
            ],
        )
    ...
    def test_optimization(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                'aggregate("product","count(bags)","count").',
                'aggregate_set("product","count(bags)","bags").',
                'path("bags",0,"bags").',
            ],
        )
