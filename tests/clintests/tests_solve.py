        ...
        "test": StableModels(
            {
                ...
                'associate(("root.bikes[0].frame[0]","root.bikes[0].saddle[0]"),"saddle",0,"frame",0)',
                'associate(("root.bikes[1].frame[0]","root.bikes[1].saddle[0]"),"saddle",0,"frame",0)',
            }
        ),
    },
    "self_association": {
        "test": StableModels(
            {
                ...
                'associate(("root.left_bag[0]","root.right_bag[1]"),"other_side",0,"other_side",0)',
                'associate(("root.left_bag[1]","root.right_bag[0]"),"other_side",0,"other_side",0)',
            ...
            },
            {
                ...
                'include("root.right_bag[0]")',
                'include("root.right_bag[1]")',
                'associate(("root.left_bag[0]","root.right_bag[0]"),"other_side",0, "other_side",0)',
                'associate(("root.left_bag[1]","root.right_bag[1]"),"other_side",0, "other_side",0)',
        ...
        "test": StableModels(
            {
                ...
                'associate(("root.persons[0]","root.rooms[1]"),"roomsOwned",0,"owner",0)',
                'associate(("root.persons[0]","root.things[0]"),"thingOwned",0,"owner",0)',
                'associate(("root.persons[1]","root.rooms[0]"),"roomsOwned",0,"owner",0)',
                'associate(("root.persons[1]","root.things[1]"),"thingOwned",0,"owner",0)',
                'associate(("root.rooms[0]","root.things[1]"),"things",0,"storedInRoom",0)',
                'associate(("root.rooms[1]","root.things[0]"),"things",0,"storedInRoom",0)',
            ...
            },
            {
                ...
                'include("root.things[0]")',
                'include("root.things[1]")',
                'associate(("root.persons[0]","root.rooms[0]"),"roomsOwned",0,"owner",0)',
                'associate(("root.persons[0]","root.things[0]"),"thingOwned",0,"owner",0)',
                'associate(("root.persons[1]","root.rooms[1]"),"roomsOwned",0,"owner",0)',
                'associate(("root.persons[1]","root.things[1]"),"thingOwned",0,"owner",0)',
                'associate(("root.rooms[0]","root.things[0]"),"things",0,"storedInRoom",0)',
                'associate(("root.rooms[1]","root.things[1]"),"things",0,"storedInRoom",0)',
