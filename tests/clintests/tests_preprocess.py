    ...
    "unbounded_multishot_association": {
        "test": StableModels(
            ...
            | {
                ...
                'inc_set("root.elements[0].modules")',
                'inc_set("root.elements[1].modules")',
                'incremental("function","count(root.elements[0].modules)",("count(root.elements[0].modules)","count","root.elements[0].modules"))',
                'incremental("function","count(root.elements[1].modules)",("count(root.elements[1].modules)","count","root.elements[1].modules"))',
                'incremental("association","modules",("root.elements[0]","Module","modules",1,2))',
                'incremental("association","modules",("root.elements[1]","Module","modules",1,2))',
                'incremental("path","root.elements[0].modules[0]",())',
                'incremental("path","root.elements[0].modules[1]",())',
                'incremental("path","root.elements[1].modules[0]",())',
                'incremental("path","root.elements[1].modules[1]",())',
                'incremental("path","root.elements[1].modules[1].type[0]",())',
                'incremental("path","root.elements[1].modules[0].type[0]",())',
                'incremental("path","root.elements[0].modules[1].type[0]",())',
                'incremental("path","root.elements[0].modules[0].type[0]",())',
                'incremental("binary","count(root.elements[0].modules)=1",("count(root.elements[0].modules)=1","count(root.elements[0].modules)","=","1"))',
                'incremental("binary","count(root.elements[1].modules)=1",("count(root.elements[1].modules)=1","count(root.elements[1].modules)","=","1"))',
                'incremental("binary","root.elements[1].modules[1].type[0]=I",("root.elements[1].modules[1].type[0]=I","root.elements[1].modules[1].type[0]","=","I"))',
                'incremental("binary","root.elements[1].modules[0].type[0]=I",("root.elements[1].modules[0].type[0]=I","root.elements[1].modules[0].type[0]","=","I"))',
                'incremental("binary","root.elements[0].modules[1].type[0]=I",("root.elements[0].modules[1].type[0]=I","root.elements[0].modules[1].type[0]","=","I"))',
                'incremental("binary","root.elements[0].modules[0].type[0]=I",("root.elements[0].modules[0].type[0]=I","root.elements[0].modules[0].type[0]","=","I"))',
                'incremental("binary","count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I",("count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I","count(root.elements[1].modules)=1","&&","root.elements[1].modules[1].type[0]=I"))',
                'incremental("binary","count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I",("count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I","count(root.elements[1].modules)=1","&&","root.elements[1].modules[0].type[0]=I"))',
                'incremental("binary","count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I",("count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I","count(root.elements[0].modules)=1","&&","root.elements[0].modules[1].type[0]=I"))',
                'incremental("binary","count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I",("count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I","count(root.elements[0].modules)=1","&&","root.elements[0].modules[0].type[0]=I"))',
                'incremental("binary","!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I",("!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I","!root.elements[1].type[0]=A","||","count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I"))',
                'incremental("binary","!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I",("!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I","!root.elements[1].type[0]=A","||","count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I"))',
                'incremental("binary","!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I",("!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I","!root.elements[0].type[0]=A","||","count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I"))',
                'incremental("binary","!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I",("!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I","!root.elements[0].type[0]=A","||","count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I"))',
                'incremental("constraint","!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I",((0,"!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I"),"boolean"))',
                'incremental("constraint","!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I",((0,"!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I"),"boolean"))',
                'incremental("constraint","!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I",((0,"!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I"),"boolean"))',
                'incremental("constraint","!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I",((0,"!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I"),"boolean"))',
            }
        ),
        "files": ["unbounded_association.lp"],
    },
