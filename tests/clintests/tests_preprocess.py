...
TESTS_PREPROCESS: dict[str, dict[str, Any]] = {
    ...
    "unbounded_multishot_association": {
        "test": StableModels(
            ...
            | {
                'inc_set("root.modules")',
                'incremental("function","count(root.elements[0].modules)","root.modules",("count(root.elements[0].modules)","count","root.elements[0].modules"))',
                'incremental("function","count(root.elements[1].modules)","root.modules",("count(root.elements[1].modules)","count","root.elements[1].modules"))',
                'incremental("association","modules","root.modules",("root.elements[0]","Module","modules",1,2))',
                'incremental("association","modules","root.modules",("root.elements[1]","Module","modules",1,2))',
                'incremental("path","root.elements[0].modules[0]","root.modules",("root.elements[0].modules[0]","root.modules"))',
                'incremental("path","root.elements[0].modules[1]","root.modules",("root.elements[0].modules[1]","root.modules"))',
                'incremental("path","root.elements[1].modules[0]","root.modules",("root.elements[1].modules[0]","root.modules"))',
                'incremental("path","root.elements[1].modules[1]","root.modules",("root.elements[1].modules[1]","root.modules"))',
                'incremental("path","root.elements[1].modules[1].type[0]","root.modules",("root.elements[1].modules[1].type[0]","root.modules"))',
                'incremental("path","root.elements[1].modules[0].type[0]","root.modules",("root.elements[1].modules[0].type[0]","root.modules"))',
                'incremental("path","root.elements[0].modules[1].type[0]","root.modules",("root.elements[0].modules[1].type[0]","root.modules"))',
                'incremental("path","root.elements[0].modules[0].type[0]","root.modules",("root.elements[0].modules[0].type[0]","root.modules"))',
                'incremental("binary","count(root.elements[0].modules)=1","root.modules",("count(root.elements[0].modules)=1","count(root.elements[0].modules)","=","1"))',
                'incremental("binary","count(root.elements[1].modules)=1","root.modules",("count(root.elements[1].modules)=1","count(root.elements[1].modules)","=","1"))',
                'incremental("binary","root.elements[1].modules[1].type[0]=I","root.modules",("root.elements[1].modules[1].type[0]=I","root.elements[1].modules[1].type[0]","=","I"))',
                'incremental("binary","root.elements[1].modules[0].type[0]=I","root.modules",("root.elements[1].modules[0].type[0]=I","root.elements[1].modules[0].type[0]","=","I"))',
                'incremental("binary","root.elements[0].modules[1].type[0]=I","root.modules",("root.elements[0].modules[1].type[0]=I","root.elements[0].modules[1].type[0]","=","I"))',
                'incremental("binary","root.elements[0].modules[0].type[0]=I","root.modules",("root.elements[0].modules[0].type[0]=I","root.elements[0].modules[0].type[0]","=","I"))',
                'incremental("binary","count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I","root.modules",("count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I","count(root.elements[1].modules)=1","&&","root.elements[1].modules[1].type[0]=I"))',
                'incremental("binary","count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I","root.modules",("count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I","count(root.elements[1].modules)=1","&&","root.elements[1].modules[0].type[0]=I"))',
                'incremental("binary","count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I","root.modules",("count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I","count(root.elements[0].modules)=1","&&","root.elements[0].modules[1].type[0]=I"))',
                'incremental("binary","count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I","root.modules",("count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I","count(root.elements[0].modules)=1","&&","root.elements[0].modules[0].type[0]=I"))',
                'incremental("binary","!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I","root.modules",("!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I","!root.elements[1].type[0]=A","||","count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I"))',
                'incremental("binary","!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I","root.modules",("!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I","!root.elements[1].type[0]=A","||","count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I"))',
                'incremental("binary","!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I","root.modules",("!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I","!root.elements[0].type[0]=A","||","count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I"))',
                'incremental("binary","!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I","root.modules",("!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I","!root.elements[0].type[0]=A","||","count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I"))',
                'incremental("constraint","!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I","root.modules",((0,"!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[1].type[0]=I"),"boolean"))',
                'incremental("constraint","!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I","root.modules",((0,"!root.elements[1].type[0]=A||count(root.elements[1].modules)=1&&root.elements[1].modules[0].type[0]=I"),"boolean"))',
                'incremental("constraint","!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I","root.modules",((0,"!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[1].type[0]=I"),"boolean"))',
                'incremental("constraint","!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I","root.modules",((0,"!root.elements[0].type[0]=A||count(root.elements[0].modules)=1&&root.elements[0].modules[0].type[0]=I"),"boolean"))',
            }
        ),
        "files": ["unbounded_association.lp"],
    },
