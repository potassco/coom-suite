...
class ModelParser(Parser):
    ...
    def product(self):
        ...
        try:
            ...
            if (
                ((_la) & ~0x3F) == 0
                and ((1 << _la) & ((1 << ModelParser.T__6) | (1 << ModelParser.T__15) | (1 << ModelParser.T__17))) != 0
            ) or (
                (((_la - 70)) & ~0x3F) == 0
                and (
                    (1 << (_la - 70))
        ...
        try:
            ...
            while (((_la - 13)) & ~0x3F) == 0 and (
                ...
                & (
                    ...
                    | (1 << (ModelParser.T__66 - 13))
                    | (1 << (ModelParser.T__67 - 13))
                    | (1 << (ModelParser.T__68 - 13))
        ...
        try:
            ...
            while (((_la - 12)) & ~0x3F) == 0 and (
                ...
                & (
                    ...
                    | (1 << (ModelParser.T__48 - 12))
                    | (1 << (ModelParser.T__49 - 12))
                    | (1 << (ModelParser.T__50 - 12))
                    | (1 << (ModelParser.T__51 - 12))
                    ...
                    | (1 << (ModelParser.T__66 - 12))
                    | (1 << (ModelParser.T__67 - 12))
                    | (1 << (ModelParser.T__68 - 12))
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 47))
                        & (
                            (1 << (ModelParser.T__46 - 47))
                            | (1 << (ModelParser.INTEGER - 47))
                            | (1 << (ModelParser.FLOATING - 47))
                        )
                    )
                    != 0
                )
